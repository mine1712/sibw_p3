...
--
-- Servidor: db
-- Tiempo de generación: 22-05-2026 a las 11:56:35
...
(8, 5, 'Pepe', 'correodepepe@gmail.com', 'Que bien que lo han arreglado tan rápido.Y que bien luce FONSECA\r\n\n\n(Mensaje editado por el moderador)', '2026-04-30 09:25:14');
...
(21, 1, 'noticia_1_1778757836_0.png', '', 1);
...
INSERT INTO `noticia` (`id`, `titulo`, `fecha`, `tipo`, `concejalia`, `personas`, `lugar_id`, `descripcion`, `gravedad`, `hashtags`) VALUES
(1, 'Derrumbe en vivienda antigua', '2026-04-13 08:00:00', 'Urgencia', 'Urbanismo', 'Bomberos', 1, 'Grietas estructurales detectadas.', 'Crítico', '#Urgencia #Urbanismo #Derrumbe'),
(2, 'Socavón por lluvia', '2026-04-13 09:00:00', 'Vía Pública', 'Mantenimiento', 'Técnicos', 3, 'Hundimiento en el asfalto.', 'Grave', '#VíaPública #Mantenimiento #Socavón'),
(3, 'Banco roto en Parque Central', '2026-04-19 16:03:31', 'Mobiliario Urbano', 'Mantenimiento / Vía Pública', 'Reportado por ciudadano', 1, 'Se ha encontrado un banco de madera y forja completamente destrozado en la zona central del parque. Las tablas están sueltas y representan un peligro.', 'Normal', '#MobiliarioUrbano #ParqueCentral #Reparación'),
(4, 'Levantamiento de acera por raíces', '2026-04-20 10:30:00', 'Mantenimiento', 'Medio Ambiente', 'Técnicos de Parques y Jardines', 2, 'Raíces de árbol de gran porte han fracturado y levantado el pavimento, provocando riesgo de tropezones.', 'Grave', '#Mantenimiento #MedioAmbiente #Aceras'),
(5, 'Contenedor de papel quemado por vandalismo', '2026-04-20 16:30:00', 'Vandalismo', 'Medio Ambiente', 'Reportado por ciudadano', 1, 'Contenedor azul para reciclaje de papel y cartón ha sufrido graves daños por fuego en la parte superior. La tapa azul está parcialmente derretida y deformada. Se requiere sustitución.', 'Grave', '');
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('anonimo','usuario','moderador','gestor','administrador') NOT NULL DEFAULT 'anonimo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 'mcm17@correo.ugr.es', '$2y$10$09PsVZWxbBVHWW4YGdknSO2Ebie27xMOaIQipAh4/Oo8FzH6qlT8a', 'usuario'),
(2, 'admin@admin.com', '$2y$10$kY2/Kfb0k/orehgNnGrc4OHUuTqd6Zu1KWG8bnnrRSWYi0bo2RyRq', 'administrador'),
(19, 'moderador@moderador.com', '$2y$10$HkdW1vyDGwCAsBmjp.PoCO1IdO3EMZLblYdf6hEWVGTNKlape/Ufq', 'moderador'),
(20, 'gestor@gestor.com', '$2y$10$WnX0te/VxUK5KTmFTc0.O.uTt.9ThUcU21/nvI3OMbN9PjR1.APgq', 'gestor'),
(23, 'admin3@admin.com', '$2y$10$tHfUn3HRFiYorkzBkcMdWO7eDqAux1EF3/7Ug8VgP50p8Cf6UbMfq', 'administrador');
